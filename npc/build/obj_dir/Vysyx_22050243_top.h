...
#ifndef VERILATED_VYSYX_22050243_TOP_H_
#define VERILATED_VYSYX_22050243_TOP_H_  // guard

#include "verilated_heavy.h"
#include "svdpi.h"

class Vysyx_22050243_top__Syms;
class Vysyx_22050243_top___024root;
class VerilatedVcdC;
class Vysyx_22050243_top_VerilatedVcd;


// This class is the main interface to the Verilated model
class Vysyx_22050243_top VL_NOT_FINAL {
  private:
    // Symbol table holding complete model state (owned by this class)
    Vysyx_22050243_top__Syms* const vlSymsp;
  ...
  public:
    ...
    Vysyx_22050243_top___024root* const rootp;
    ...
    explicit Vysyx_22050243_top(VerilatedContext* contextp, const char* name = "TOP");
    explicit Vysyx_22050243_top(const char* name = "TOP");
    /// Destroy the model; called (often implicitly) by application code
    virtual ~Vysyx_22050243_top();
  private:
    VL_UNCOPYABLE(Vysyx_22050243_top);  ///< Copying not allowed
